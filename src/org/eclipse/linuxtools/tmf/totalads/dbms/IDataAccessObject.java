...
/**
 * Database Management System (IDataAccessObject) class. This class connects with MongoDB,
...
public interface IDataAccessObject extends IDBMSSubject {
	...
	/**
	 * Selects all the documents as a IDBCursor Object which can be used to iterate through them
	 * @param database Database name
	 * @param collection Collection name
