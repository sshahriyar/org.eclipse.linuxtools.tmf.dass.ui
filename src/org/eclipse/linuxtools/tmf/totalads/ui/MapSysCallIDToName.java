...
public static Integer getSysCallName(Integer id){
 ...
 static{
	...
	/* 
	 sysCallIDToName.put("sys_recvfrom",501);
	sysCallIDToName.put("sys_sendmsg",502);
	sysCallIDToName.put("sys_sendto",503);
	sysCallIDToName.put("sys_mmap",504);
	sysCallIDToName.put("sys_socket",505);
	sysCallIDToName.put("sys_connect",506);
	sysCallIDToName.put("sys_bind",507);
	sysCallIDToName.put("sys_getsockname",508);
	sysCallIDToName.put("sys_recvmsg",509);
	sysCallIDToName.put("sys_socketpair",510);
	sysCallIDToName.put("sys_shutdown",510);
	sysCallIDToName.put("sys_unknown",-1);
	*/
