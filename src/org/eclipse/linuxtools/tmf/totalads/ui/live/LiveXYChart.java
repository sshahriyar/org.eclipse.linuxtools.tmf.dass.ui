...
public class LiveXYChart {
    ...
    public LiveXYChart(Composite compParent) {
        ...
        fXyChart.getAxisSet().getXAxis(0).getTitle().setText("Time (mins)"); //$NON-NLS-1$
        fXyChart.getAxisSet().getYAxis(0).getTitle().setText("Anomalies"); //$NON-NLS-1$
    ...
    /**
     * This function initialises different series in a chart. It must be called
    ...
    public void drawChart() {
        ...
        Display.getDefault().syncExec(new Runnable() {// Always execute on the
                    ...
                    public void run() {
                        ...
                        // fXyChart.redraw(, y, width, height, all);;
                    }
                });
    }
