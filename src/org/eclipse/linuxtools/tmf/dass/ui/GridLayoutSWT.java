...
///--
    ...
    Text txtAnotherTest = new Text(group, SWT.BORDER | SWT.READ_ONLY | SWT.H_SCROLL | SWT.V_SCROLL | SWT.CANCEL);
    
    txtAnotherTest.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true,true));
    //txtAnotherTest.
